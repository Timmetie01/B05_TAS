...
take_3.plot_trajectory_center(part='sections', XYZ=(True, True, True), color='darkblue', showplot=False, type='line', label='Trajectory Center')
take_3.plot_trajectory_center(part='target', XYZ=(True, True, True), color='firebrick', showplot=False, type='scatter', label='Target Center')
take_3.plot_operations('target', ('derivative_0'), (True, True, True), color='firebrick', label='Target', showplot=False)
